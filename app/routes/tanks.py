...
# ==============================
# 1) ENDPOINTS DE STATUS (arriba para evitar conflicto con /{tank_id})
# ==============================
...
def list_tanks_status(
    ...
    """
    Estado/color por tanque (gris si sin datos).
    Usa v_tank_latest_full + alarms de LEVEL.
    """
    org_id = require_org()
    try:
        ...
        # devolvemos 200 con lista vacía para que el frontend no muera
        return []
...
def list_tanks(
    ...
    try:
        ...
        import traceback; traceback.print_exc()
        # Devolvemos 500 con detalle claro
...
def create_tank(
    ...
    try:
        ...
        raise HTTPException(status_code=400, detail="Tank already exists")
